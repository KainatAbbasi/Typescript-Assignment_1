...
// the album information correctly. Add an optional parameter to make_album() that allows you to
//  store the number of tracks on an album. If the calling line includes a value for the number of tracks, 
...
album = make_album('Zaviyar', 'seenbreez')
console.log(album)